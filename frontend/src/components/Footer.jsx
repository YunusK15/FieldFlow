    ...
    <footer className="site-footer">
      <div className="footer-inner">
        <div className="footer-grid">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <h2 className="text-gray-900 text-lg font-bold">FieldFlow</h2>
            </div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-widest text-gray-600 mb-3">Navigate</h3>
          ...
          {/* Resources */}
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-widest text-gray-600 mb-3">Resources</h3>
            <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-2">
          <p className="text-xs text-gray-500">© {new Date().getFullYear()} FieldFlow. Built with 🌱 for a greener world.</p>
          <p className="text-xs text-gray-500">Powered by AI · PyTorch · React</p>
        </div>
      </div>
    </footer>
  )
